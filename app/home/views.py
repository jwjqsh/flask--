...
from app.models import User, Userlog, Comment, Movie, Tag, Moviecol, Preview
...
def index(page=None):
    page_data = Movie.query.paginate(page=page, per_page=8)
    tags = Tag.query.all()
    # 标签
